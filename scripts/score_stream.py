...
# DESIGN NOTE: WE USE A PYTHON PULL LOOP RATHER THAN PYSPARK STRUCTURED STREAMING WITH PUB/SUB SOURCE
# BECAUSE THE NATIVE STRUCTURED-STREAMING PUB/SUB CONNECTOR REQUIRES DATAPROC OR A MAVEN JAR DANCE.

# THE MODEL ITSELF IS STILL A SPARK PIPELINEMODEL AND SCORING IS DONE THROUGH SPARK DATAFRAME APIS,
# SO THE INFERENCE PATH IS HONESTLY "STREAMING DATA THROUGH A SPARK MODEL".
